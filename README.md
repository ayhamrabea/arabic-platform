...
- 📊 Панель прогресса (Dashboard)  
- 🧩 Компонентная архитектура  
- 🌍 Поддержка масштабирования и новых функций
...
Функциональность постепенно расширяется, архитектура готова к добавлению новых возможностей (тесты, уровни, сертификаты и т.д.).
...
GitHub: https://github.com/ayhamrabea
